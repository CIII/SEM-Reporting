...
CONVERSION_NAME = 'testconversionbucket'
# Your click ID must be less than 30 days old.
CLICK_ID = 'CjwKEAjw-abABRDquOTJi8qdojwSJABt1S1OcKb-o4psVHfynlHvGisi7JCWe5VX6p_VkIKQlVuZhBoCYhDw_wcB'
# The conversion time must be more recent than the time of the click.
time = '2016-10-21 17:47:50'
from datetime import datetime
#isotime = datetime.strptime(time, "%Y-%m-%d %H:%M:%S").isoformat()

#datetime reference:  https://developers.google.com/adwords/api/docs/appendix/codes-formats#date-and-time-formats
CONVERSION_TIME = "20161021 174750 America/New_York"
CONVERSION_VALUE = "83.09"
...
def main(client, conversion_name, click_id, conversion_time, conversion_value):
  ...
  offline_conversion_feed_service = client.GetService(
      'OfflineConversionFeedService', version='v201609')
